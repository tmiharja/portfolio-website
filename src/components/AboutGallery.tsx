...
// in front. Photos are monochrome until hovered (see .photo-mono).
export default function AboutGallery() {
  return (
    <Reveal className="mt-16 sm:mt-20">
      <div aria-label="Photos of Toni" role="group" className="relative aspect-[5/2] w-full">
        <div className="photo-veil photo-mono absolute left-0 top-[10%] aspect-[3/2] w-[46%] -rotate-2 overflow-hidden rounded-xl shadow-md">
          <Image
            src={about1}
        ...
        <div className="photo-veil photo-mono absolute right-0 top-[16%] aspect-[3/2] w-[46%] rotate-2 overflow-hidden rounded-xl shadow-md">
          <Image
            src={about3}
        ...
        <div className="photo-veil photo-mono absolute left-1/2 top-0 z-10 aspect-square w-[36%] -translate-x-1/2 overflow-hidden rounded-xl shadow-lg ring-4 ring-background">
          <Image
            src={about2}
